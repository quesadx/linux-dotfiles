...
let
  ...
  userPackages = with pkgs; [
    # File management
    nautilus file-roller unzip unrar p7zip  # GUI file manager, archive tools
    # GNOME ap
    gnome-photos gnome-music gnome-calendar  # Media apps
    gnome-calculator gnome-text-editor       # Utilities
    gnome-font-viewer gnome-console          # System apps
    adwaita-icon-theme glib gtk3             # GNOME theming
    # Accessory & productivity
    fastfetch papers showtime rnote          # System info, note-taking
    dconf-editor onlyoffice-desktopeditors   # Config editor, Office suite
    obsidian dbeaver-bin mysql-workbench     # Knowledge base, DB tools
    mongodb-compass spotify tmux alacritty    # Database, music, terminal
    calcure gnome-calendar                    # Calendar/scheduling
    # Development tools
    claude-code direnv nix-direnv            # CodeAI, environment management
  ...
  firefoxExtensions = {
    "uBlock0@raymondhill.net" = {                    # Adblocker
...

{
  ...
  programs.helix.extraPackages = with pkgs; [
    nixd nixfmt                                 # Nix formatter & LSP
    wl-clipboard xclip                          # Clipboard support
